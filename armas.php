		   ...
		   if($username != "visitante"){
			...
			<div class="row">
				<?php while($rows_produtos = mysqli_fetch_assoc($resultado_produtos)){
					...
					<div class="card">
							<figure class="produto"><img style="height: 15rem;" class="card-img-top" src="<?php echo utf8_decode($rows_produtos['imagem']); ?>" alt="..."></figure>
							<div class="card-body">
								<div class="caption text-center">
								<a href="detalhes.php?id_produtos=<?php echo $rows_produtos['id']; ?>"><h5 class="card-title"><?php echo utf8_decode($rows_produtos['nome']); ?></h5></a>
									<h5 class="card-title">BTC <?php echo utf8_decode($rows_produtos['preco']); ?></h5>
