...
if($row > 0) {
	...
	$result = mysqli_query($conexao, "SELECT id FROM usuario WHERE email = '$email'") or die (mysqli_error());
...
?><div class="alert alert-info" role="alert"><?php
	echo '<center>Login realizado com sucesso.<br><a href = "produto.php">Ir as compras!</a></center>';
	echo "<script>loginsuccesfully</script>";?></div><?php
	
} else {
	?><div class="alert alert-danger" role="alert"><?php
	echo '<center>Usuário ou senha incorreto.<a href = "login.php">Tentar novamente.</a></center>';
    echo "<script> loginfailed </script>";?></div><?php
}
